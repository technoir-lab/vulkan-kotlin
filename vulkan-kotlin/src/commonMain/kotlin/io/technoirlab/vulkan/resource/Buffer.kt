...
class Buffer internal constructor(
    ...
    fun bindMemory(memory: DeviceMemory, offset: ULong = 0uL): Unit = memScoped {
        ...
        val bindImageMemoryInfo = alloc<VkBindBufferMemoryInfo> {
     ...
     */
    fun getDeviceAddress(): ULong = memScoped {
        val addressInfo = alloc<VkBufferDeviceAddressInfo> {
    ...
    fun getMemoryRequirements(): MemoryRequirements = memScoped {
        val memoryRequirementsInfo = alloc<VkBufferMemoryRequirementsInfo2> {
