 ...
 */
fun Instance.createWaylandSurface(display: CPointer<wl_display>, surface: CPointer<wl_surface>): Surface = memScoped {
    ...
    val surfaceCreateInfo = alloc<VkWaylandSurfaceCreateInfoKHR> {
